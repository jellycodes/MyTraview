  ...
  useEffect(() => {
    ...
    function displayPlaces(places) {
      ...
      for (var i = 0; i < places.length; i++) {
        ...
        //마커의 위도 및 경도와 장소명 추출
        // console.log("마커의 위치는: "+placePosition+ "마커 장소이름은 " + places[i].place_name);
    ...
    function getListItem(index, places) {
      ...
      itemStr += '  <span class="tel">' + places.phone + '</span>' ;
        ...
        itemStr += '  <span class="review" style="float:right"></span>' +
        '</div>';
        
        el.innerHTML = itemStr;
        el.className = 'item';

        console.log(el.getElementsByClassName("review"));
